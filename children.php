...
on all sides by steep rocky mountains.</pre>";
					...
					echo"	<a href='childrenpdf\البيت_الجديد.pdf'class='add-to-cart btn btn-default' type='button'> read book</a>";}
					
					else if($_REQUEST['id']==14){
						echo"<a href='childrenpdf\الأرنب_الذكي.pdf'class='add-to-cart btn btn-default' type='button'> read book</a>";
					}
					else if($_REQUEST['id']==15){
						echo"<a href='childrenpdf\شيماء تحكي.pdf'class='add-to-cart btn btn-default' type='button'> read book</a>";
					}
					
					else{ 
						echo"<a href='childrenpdf\نهر الذهب.pdf'class='add-to-cart btn btn-default' type='button'> read book</a>";
					}
